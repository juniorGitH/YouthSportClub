...
// Import video as a URL asset so Parcel treats it as a file (no transformer needed)
  ...
  <section className="section join-club-section">
    ...
    <div className="join-layout">
      ...
      <div className="join-content">
        ...
        <p>
          Offrez à votre enfant ou à vous-même un encadrement sportif de qualité avec des coachs
          expérimentés, un suivi personnalisé et une communauté engagée.
        </p>
    ...
    <section className="private-training-showcase">
      ...
      <p className="centered-intro">
        Des séances privées adaptées aux objectifs, au niveau et au rythme de chaque athlète.
      </p>
      ...
      <div className="testimonials-section">
        ...
        <div className="testimonial-card">
          ...
          <blockquote>
            Merci pour tout ce que vous avez pour notre famille, on est tellement contents d’avoir
            pu commencer cette aventure de YSC depuis les premiers jours. Vous êtes une équipe
            exceptionnelle avec beaucoup de potentiel et opportunité. N’arrêtez pas de suivre vos
            rêves, vous avez une passion, vision, et expertise unique ! Nous n’allons jamais vous
            oublier.
          </blockquote>
...
export const ResultsPage = () => (
  <section className="section">
    ...
    <article className="card wide">
      <p>
        Le Youth Sports Club confirme sa régularité par des distinctions collectives et
        individuelles, reflet d&apos;un encadrement rigoureux.
      </p>
    </article>
  </section>
);
  ...
  <section className="section section-alt">
    ...
    <div className="grid two-columns">
      <article className="card">
        ...
        <p>
          Axés sur les fondamentaux techniques, le développement de la motricité et l&apos;esprit
          d&apos;équipe.
        </p>
        <ul>
      ...
      <article className="card">
        ...
        <p>Pour les athlètes confirmés visant l&apos;excellence nationale et internationale.</p>
        <ul>
      ...
      <article className="card">
        ...
        <p>Sport bien-être, remise en forme et pratique conviviale.</p>
        <ul>
      ...
      <article className="card">
        ...
        <ul>
          <li>
            <strong>Lundi - Mercredi - Vendredi :</strong> 16h - 19h (Jeunes & Élite)
          </li>
          <li>
            <strong>Samedi :</strong> 08h - 12h (Tous niveaux)
          </li>
          <li>
            <strong>Dimanche :</strong> Séances spécifiques sur rendez-vous
          </li>
        </ul>
      </article>
    </div>
