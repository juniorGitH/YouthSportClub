...
const scoped = `
  ...
  .ysc-private__cta::after {
    ...
    position: absolute;
    inset: 0;
    background: linear-gradient(to bottom, rgba(13, 45, 84, 0.8), rgba(13, 45, 84, 0.4));
    pointer-events: none;
    z-index: 1;
  }
  ...
  return (
    <>
      ...
      <section className="ysc-join-hero">
        ...
        <div className="ysc-join-hero__image-col">
          <img
            src={joinImage}
            alt="Equipe du Youth Sports Club"
    ...
    <section className="ysc-private" aria-labelledby="private-heading">
      ...
      <div className="ysc-private__cta">
        ...
        <a href="#registration-form" onClick={scrollToForm} className="ysc-btn ysc-btn--white">
