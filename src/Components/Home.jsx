...
const missionPiliers = [
  { title: "Axe Sport & Bien-être",  desc: "Gymnastique, Boxe et Fitness pour tous les profils et niveaux." },
  { title: "Axe Excellence",         desc: "Détection et préparation des athlètes aux compétitions nationales." },
  { title: "Discipline & confiance", desc: "Aider les jeunes à développer persévérance et confiance en soi." },
  { title: "Inclusion sociale",      desc: "Le sport comme outil d'éducation et de transformation sociale." },
];
...
const scoped = `
  ...
  .ysc-pilier p { font-size: 0.82rem; color: #3f6085; line-height: 1.5; margin: 0; }
  ...
  @media (max-width: 768px) {
    ...
    .ysc-pilier-grid { grid-template-columns: 1fr; }
  ...
  return (
    <>
      ...
      <section className="section">
        ...
        <div className="wide">
          <div className="ysc-pilier-grid">
            {missionPiliers.map((p) => (
              <div className="ysc-pilier" key={p.title}>
                <h4>{p.title}</h4>
                <p>{p.desc}</p>
              </div>
            ))}
